...
import { getIntrospectionQuery, buildClientSchema, printSchema, typeFromAST, astFromValue } from 'graphql/utilities';
import { appendFile, readFileSync } from 'fs';


const ourDBintrospectionResult = {
  'data': {
    '__schema': {
      'queryType': {
        'name': 'Query'
...
//-------------------------------------
const generateClientSchema = (introspection) => {
  const result = buildClientSchema(introspection.data);
 /*  appendFile('clientSchema.json', JSON.stringify(result), (err) => {
    if (err) {
      console.log(err);
    }
    else {
      ...
      console.log('\nFile Contents of file after append:',
        readFileSync('clientSchema.json', 'utf8'));
    }
  }); */
  return result;
}
...
const findTypefromAST = (schema, inputType) => {
  /* const inputType = astFromValue(value, type);
  console.log(inputType); */
  const result = typeFromAST(schema, inputType);
  return result;
}

//-------------------------------------

/*generateClientSchema(introspectionResult);
console.log(printSchema(generateClientSchema(introspectionResult)));
console.log('\n');
console.log('This is the query AST: ', print(queryAST)); */
