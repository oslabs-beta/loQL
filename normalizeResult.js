      ...
      if (Array.isArray(value)) {
        ...
        result[key] = value.map((subArrayVal) => {
          if (typeof subArrayVal === 'object' && subArrayVal !== null) {
            if (!subArrayVal.id) return subArrayVal; // maybe return undefined
        ...
        // If undefined: Any key which has an array containing undefined values should be deleted from the object...?
